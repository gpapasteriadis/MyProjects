...
public class chooseAchievementFrame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public chooseAchievementFrame() {
		setTitle("Update Achievements");
		...
		JLabel lblNewLabel = new JLabel("These are the existing Achievements, choose one to update:");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel.setBounds(31, 11, 550, 33);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Enter the number of Achievement you've chosen:");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1.setBounds(31, 277, 394, 25);
		...
		String text="";
		System.out.println("prosorino: "+CVEditor.getItem().getBulletList().size());
		...
		button.setBounds(533, 321, 86, 33);
