...
public class updateChosenCourseFrame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public updateChosenCourseFrame() {
		...
		panel.setBounds(14, 0, 625, 437);
		contentPane.add(panel);
		
		textField = new JTextField();
		textField.setColumns(10);
		textField.setBounds(297, 31, 276, 20);
		panel.add(textField);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(297, 112, 276, 20);
		panel.add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(297, 193, 276, 20);
		panel.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(297, 264, 276, 20);
		...
		lblUpdate.setBounds(389, 355, 63, 39);
		panel.add(lblUpdate);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				CVEditor.getCV().getSections().get(4).getBulletList().set(CVEditor.getIndexItem()-1,CVEditor.getItem()); //replace with updated item
				dispose();
		...
		button.setBounds(470, 357, 103, 35);
		panel.add(button);
		
		JLabel label = new JLabel("(*)These fields must be filled");
		label.setForeground(Color.RED);
		label.setBounds(12, 410, 235, 15);
		panel.add(label);
		
		JLabel label_4 = new JLabel("(*)");
		label_4.setForeground(Color.RED);
		label_4.setBounds(580, 266, 33, 15);
		panel.add(label_4);
	}
