...
public class addAchievementsFrame extends JFrame {
	...
	public addAchievementsFrame() {
		...
		JLabel achievementPanel = new JLabel("Achievement:");
		achievementPanel.setFont(new Font("Tahoma", Font.BOLD, 14));
		achievementPanel.setBounds(52, 63, 122, 24);
		panel.add(achievementPanel);
		
		JLabel addAchievementPanel = new JLabel("Do you want to add a new Achievement?");
		...
		yesButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				achievement = achievementField.getText();
				Paragraph p = new Paragraph(achievement);
